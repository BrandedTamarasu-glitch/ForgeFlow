...
const checks = [
  ...
  ['renders markdown', markdown.includes('# Forgeflow Release Consumption Loop') && markdown.includes('## Completion') && markdown.includes('## Dogfood Report') && markdown.includes('downstream-smoke')],
