...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-health forgeflow-health-timeline forgeflow-learning-status forgeflow-learnings forgeflow-metrics forgeflow-next-work-outcome forgeflow-noisy-command forgeflow-pattern-review forgeflow-pilot forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-runtime-drift forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  build-scope-manifest.js check-agent-drift.js check-codex-agent-drift.js check-context-budget.js check-implementation-notes.js check-profile-compliance.js check-project-learnings.js check-user-profile.js context-telemetry.js
