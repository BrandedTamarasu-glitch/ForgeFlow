...
- **Project health timeline:** `/forgeflow-health-timeline` summarizes local code-map history, context-advisor history, latest-insights readiness, learning-signal quality, and comparable deltas into a compact advisory timeline.
