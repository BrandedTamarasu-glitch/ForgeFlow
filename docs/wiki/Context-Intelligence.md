...
| Validation plan | `scripts/forgeflow/render-validation-plan.js` | Maps changed files to focused validation commands, flags when full suite or source smoke are required, and includes compact failure-capture commands for failed checks without executing or writing digests. |
