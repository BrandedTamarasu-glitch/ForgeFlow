...
async function main() {
  ...
  const checks = [
    ...
    ['project intelligence next work confidence contract', hasKeys(intelligence.next_work_confidence, ['status', 'file', 'records', 'invalid_lines', 'by_outcome', 'by_source', 'recommendation'])],
