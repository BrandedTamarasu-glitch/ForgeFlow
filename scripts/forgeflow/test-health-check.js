...
const checks = [
  ...
  ['rtk warning records policy alignment impact', !fixed.checks.find((item) => item.name === 'rtk command wrapper on PATH' && item.status === 'warn') || fixed.checks.find((item) => item.name === 'rtk command wrapper on PATH').policy_alignment === 'repo-command-policy'],
