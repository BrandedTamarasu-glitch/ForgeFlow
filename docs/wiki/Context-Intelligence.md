...
| Release readiness | `scripts/forgeflow/render-release-readiness.js` | Runs local release readiness checks, release-to-install preflight, optional baseline comparison, optional snapshot writing, optional post-publish verification for local tag/changelog/release-note/source-smoke/update-smoke evidence, and optional post-publish snapshot comparison. |
