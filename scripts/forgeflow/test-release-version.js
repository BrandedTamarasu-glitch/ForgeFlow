...
const checks = [
  ...
  ['release check runs validation and stale artifact plan tests', releaseCheck.includes('node scripts/forgeflow/test-render-validation-plan.js') && releaseCheck.includes('node scripts/forgeflow/test-render-stale-artifact-plan.js')],
