---
name: forgeflow-audit
description: Run a deep Forgeflow audit for architecture, security, and maintainability risks.
---
...
In Codex, execute this skill directly. In Claude Code, run `/audit`. If slash commands are unavailable, follow the same objective manually and preserve current user instructions, local evidence, validation, security, accessibility, and repository boundaries.
