...
- **Pattern learnings:** `rollup-pattern-learnings.js` scans cross-project `.forgeflow/<project>/learnings.jsonl`, clusters known/candidate patterns, and records `.learnings-log.jsonl` for `/forgeflow-report`.
