...
Run `/forgeflow-lean-prime` when this host supports Forgeflow slash commands. If slash commands are unavailable, apply the guidance above directly and keep the same read-only boundaries.
