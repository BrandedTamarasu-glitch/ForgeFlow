...
EXPECTED_RUNTIME_HELPERS=(
  ...
  build-scope-manifest.js check-agent-drift.js check-codex-agent-drift.js check-context-contract.js check-context-budget.js check-implementation-notes.js check-profile-compliance.js check-project-learnings.js check-user-profile.js context-telemetry.js
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js privacy-boundary.js record-agent-feedback.js record-first-run-result.js record-implementation-notes.js record-next-work-outcome.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-context-retention.js render-evaluation-report.js render-first-run-guide.js render-forgeflow-report.js render-guided-repair.js render-insight-injection.js render-pattern-review.js render-post-release-install-verify.js render-profile-review.js render-release-notes.js render-release-readiness.js render-release-verify.js render-pilot-script.js render-ship-presentation.js
