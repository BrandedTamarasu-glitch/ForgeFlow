...
const opts = parseArgs(['--root', root, '--project-dir', projectDir, '--task', 'tighten lean parity', '--prime-task', 'prime lean parity', '--write-plan', '--json']);
...
const checks = [
  ...
  ['parses args', opts.root === root && opts.projectDir === projectDir && opts.task === 'tighten lean parity' && opts.primeTask === 'prime lean parity' && opts.writePlan && opts.json],
];
