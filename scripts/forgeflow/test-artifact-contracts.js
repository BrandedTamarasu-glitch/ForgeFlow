...
async function main() {
  ...
  const checks = [
    ...
    ['project intelligence user profile contract', hasKeys(intelligence.user_profile, ['status', 'injected', 'issue_count', 'records', 'files', 'guidance']) && hasKeys(intelligence.user_profile.records, ['global', 'project', 'active'])],
