...
const DEFINITIONS = [
  ...
  ['release-qualification', 'Verify actual installed or served artifacts and lifecycle behavior.', 'product-lead', ['designer', 'guardian'], ['plan', 'review', 'ship'], 'Installed, packaged or public behavior needs qualification.', 'Source-only work without release verification scope.', 'Artifact identity and target environment', 'Web HTTP/browser target; native branch pending F3.3', 'high'],
