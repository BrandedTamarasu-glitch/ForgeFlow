...
EXPECTED_COMMANDS=(
  ...
  forgeflow-research-divergence-eval handoff implement plan quick research review review-auto ship sync-upstream ui-iterate update-forgeflow
)
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  render-research-divergence-eval-results.js render-research-divergence-eval.js smoke-check.js summarize-context-telemetry.js update-forgeflow.js render-stale-artifact-plan.js render-update-verify.js render-validation-failure-capture.js render-validation-plan.js render-workflow-readiness.js show-user-profile.js user-profile.js
)
```
