---
name: smith-craft
description: Canonical Craft Intelligence reference for smith agents. Not an agent — a shared reference file. Update here, then paste into all four Smith agents.
---
