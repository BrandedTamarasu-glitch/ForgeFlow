...
| `/forgeflow-report` | Produce a script-backed status report including local metrics, false-positive thresholds, pattern freshness, context trends, project trends, latest-insights readiness/freshness, and direct next-action recommendations. |
