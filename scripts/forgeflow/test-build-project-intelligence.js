...
const checks = [
  ...
  ['implementation brief stub renders selected candidate', briefStub.includes('# Forgeflow Implementation Brief Stub') && briefStub.includes('Candidate index: 1') && briefStub.includes('Evidence strength:') && briefStub.includes('Confidence:') && briefStub.includes('What to change:') && briefStub.includes('How to prove:') && briefStub.includes('Stop when:') && briefStub.includes('## Scope To Confirm') && briefStub.includes('## Start With') && briefStub.includes('src/auth/session.ts') && briefStub.includes('## Validate With') && briefStub.includes('## Suggested Review Lanes') && briefStub.includes('Warden:') && briefStub.includes('Atlas:') && briefStub.includes('Compass:') && briefStub.includes('## Implementation Notes Seed') && briefStub.includes('spec-gap:') && briefStub.includes('validation:') && briefStub.includes('## Handoff Checklist') && briefStub.includes('Run focused validation, then full validation') && briefStub.includes('## Proof Boundary') && briefStub.includes('advisory stub') && briefStub.includes(result.artifacts.json)],
