...
const CAPABILITIES = Object.freeze(DEFINITIONS.map(([id, summary, owner, handoffs, phases, trigger, exclusion, inputs, prerequisites, cost]) => Object.freeze({
  ...
  prerequisites, cost, availability: ['change-propagation', 'visual-acceptance', 'persistence-recovery', 'review-calibration', 'provider-compatibility'].includes(id) ? 'evaluation' : 'planned',
})));
