...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-health forgeflow-learnings forgeflow-metrics forgeflow-noisy-command forgeflow-pilot forgeflow-profile forgeflow-release-check forgeflow-release-readiness forgeflow-repair forgeflow-report forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  build-scope-manifest.js check-agent-drift.js check-codex-agent-drift.js check-context-budget.js check-implementation-notes.js check-project-learnings.js check-user-profile.js context-telemetry.js
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js privacy-boundary.js record-agent-feedback.js record-implementation-notes.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-evaluation-report.js render-first-run-guide.js render-forgeflow-report.js render-guided-repair.js render-release-notes.js render-release-readiness.js render-pilot-script.js render-ship-presentation.js
