...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-context-contract forgeflow-context-retention forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-first-useful-win forgeflow-health forgeflow-health-timeline forgeflow-insight-injection forgeflow-learning-status forgeflow-learnings forgeflow-metrics forgeflow-next-action-audit forgeflow-next-work-outcome forgeflow-noisy-command forgeflow-pattern-review forgeflow-pilot forgeflow-post-release-install-verify forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-review-auto-classify forgeflow-runtime-drift forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  build-scope-manifest.js check-agent-drift.js check-codex-agent-drift.js check-context-contract.js check-context-budget.js check-implementation-notes.js check-profile-compliance.js check-project-learnings.js check-user-profile.js classify-review-auto.js context-telemetry.js
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js next-action-contract.js privacy-boundary.js record-agent-feedback.js record-first-run-result.js record-implementation-notes.js record-next-work-outcome.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-context-retention.js render-evaluation-report.js render-first-run-guide.js render-first-useful-win.js render-forgeflow-report.js render-guided-repair.js render-insight-injection.js render-pattern-review.js render-post-release-install-verify.js render-profile-review.js render-release-notes.js render-release-readiness.js render-release-verify.js render-pilot-script.js render-ship-presentation.js
  ...
  smoke-check.js summarize-context-telemetry.js update-forgeflow.js show-user-profile.js user-profile.js
)
```
