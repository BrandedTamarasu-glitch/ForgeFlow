...
| `/forgeflow-project-model` | Build and show the local advisory project operating model with domains, high-care files, risk zones, validation norms, operating preferences, agent guidance, review policy hints, and proof boundaries. |
