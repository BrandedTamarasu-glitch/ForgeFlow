---
name: builder-craft
description: Canonical Craft Intelligence reference for builder agents. Not an agent — a shared reference file. Update here, then paste into all four Builder agents.
---
