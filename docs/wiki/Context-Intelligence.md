...
| Project health timeline | `scripts/forgeflow/show-project-health-timeline.js` | Renders a read-only local timeline and comparable deltas from code-map history, context-advisor history, latest-insights readiness, and learning-signal quality. |
