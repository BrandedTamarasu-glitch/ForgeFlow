...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-context-contract forgeflow-context-retention forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-first-task-report forgeflow-first-useful-win forgeflow-health forgeflow-health-timeline forgeflow-insight-injection forgeflow-learning-policy forgeflow-learning-status forgeflow-learnings forgeflow-metrics forgeflow-next-action-audit forgeflow-next-work-outcome forgeflow-noisy-command forgeflow-output-contract forgeflow-pattern-review forgeflow-pilot forgeflow-post-release-install-verify forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-review-auto-classify forgeflow-review-auto-evidence forgeflow-runtime-drift forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-update-verify forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  build-scope-manifest.js check-agent-drift.js check-codex-agent-drift.js check-context-contract.js check-context-budget.js check-implementation-notes.js check-profile-compliance.js check-project-learnings.js check-user-profile.js classify-review-auto.js context-telemetry.js learning-signal-policy.js
  ...
  smoke-check.js summarize-context-telemetry.js update-forgeflow.js render-update-verify.js show-user-profile.js user-profile.js
)
```
