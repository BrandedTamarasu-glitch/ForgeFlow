...
Use `scripts/forgeflow/build-project-intelligence.js --next-work` for the same generated advisory candidates in a compact human-readable view without the full rollup sections.
