...
const checks = [
  ...
  ['includes failure capture plans', result.failure_capture_commands.some((item) => item.command === 'node scripts/forgeflow/test-build-context-pack.js' && item.next.includes('forgeflow-capture-output'))],
