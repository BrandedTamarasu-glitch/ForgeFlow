...
EXPECTED_COMMANDS=(
  ...
  forgeflow-research-divergence-advice forgeflow-research-divergence-eval forgeflow-command-interface-learning forgeflow-command-interface-observe handoff implement plan quick research review review-auto ship sync-upstream ui-iterate update-forgeflow
)
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  compact-command-output.js command-interface-learning.js correct-project-learning.js record-command-interface-observation.js
