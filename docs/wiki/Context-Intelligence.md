...
| Learning status | `scripts/forgeflow/show-learning-status.js` | Summarizes project learnings, user profile, agent feedback, review outcomes, next-work outcomes, and first-run results into one advisory health view. |
