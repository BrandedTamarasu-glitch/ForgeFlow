...
EXPECTED_RUNTIME_HELPERS=(
  capability-catalog.js check-change-propagation.js render-capability-entrypoints.js score-review-calibration.js select-capabilities.js
  ember-setup.js
  rtk-setup.js
