...
EXPECTED_RUNTIME_HELPERS=(
  ...
  render-research-divergence-advice.js render-research-divergence-eval-results.js render-research-divergence-eval.js render-research-divergence-study-judge.js render-research-divergence-study.js smoke-check.js summarize-context-telemetry.js update-forgeflow.js render-stale-artifact-plan.js render-update-verify.js render-validation-failure-capture.js render-validation-plan.js render-workflow-readiness.js run-research-divergence-study-codex.js run-research-divergence-study.js show-user-profile.js user-profile.js
)
```
