...
| `/forgeflow-lean-decision` | Show read-only minimum-sufficient-solution guidance for a work item, including reuse candidates, avoid-first guidance, do-not-simplify boundaries, validation minimum, known ceiling, and upgrade trigger. |
