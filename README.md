...
- **Post-publish verification:** `/forgeflow-release-readiness --post-publish` adds a local advisory block for plugin version, local tag, changelog, release-note draft, source smoke, and update smoke evidence without tagging, pushing, publishing, calling GitHub, or mutating installed files.
