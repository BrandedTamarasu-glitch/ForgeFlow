---
name: designer-design-principles
description: Canonical Design Voice reference for designer agents. Not an agent — a shared reference file. Update here, then paste into all three designer agents.
---
