...
const checks = [
  ...
  ['implement refreshes project learnings after notes', files.implement.includes('rollup-project-learnings.js --project-dir') && files.implement.includes('PROJECT_LEARNINGS_PATH')],
  ...
  ['ship refreshes project learnings', files.ship.includes('rollup-project-learnings.js') && files.ship.includes('PROJECT_LEARNINGS_PATH="${FORGEFLOW_DIR}/project-learnings.md"')],
