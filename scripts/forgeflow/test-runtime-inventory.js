...
const checks = [
  ...
  ['groups runtime helpers', helperGroupForSource('scripts/forgeflow/install-manifest.js') === 'install-update-health' && helperGroupForSource('scripts/forgeflow/render-efficiency-gap-plan.js') === 'adoption-guidance' && helperGroupForSource('scripts/forgeflow/record-review-outcome.js') === 'learning-recorders' && helperGroupForSource('scripts/forgeflow/user-profile.js') === 'user-profile' && helperGroupForSource('scripts/forgeflow/render-research-divergence.js') === 'agent-workflow' && helperGroupForSource('scripts/forgeflow/render-research-divergence-advice.js') === 'agent-workflow' && helperGroupForSource('scripts/forgeflow/render-research-divergence-eval.js') === 'agent-workflow' && helperGroupForSource('scripts/forgeflow/command-wrapper-contract.js') === 'command-wrapper' && helperGroupForSource('scripts/forgeflow/render-command-wrapper-batch.js') === 'command-wrapper'],
