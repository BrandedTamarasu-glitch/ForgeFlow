...
| Runtime inventory | `scripts/forgeflow/runtime-inventory.js` | Provides shared command and runtime-helper inventory reads for coverage tests, health inventory checks, helper owner-surface grouping, command/helper counts, installed helper names, managed-registry counts, parity status, coordination-pressure guidance, and install/update/release/docs registry consolidation. Wrapper contract and wrapper-batch helpers are grouped under the command-wrapper owner surface. |
