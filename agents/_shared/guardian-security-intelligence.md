...
description: Canonical Security Intelligence reference for guardian agents. Not an agent — a shared reference file. Update here, then paste into all three guardian agents.
---
