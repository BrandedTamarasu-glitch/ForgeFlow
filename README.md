...
- **Import-gap triage:** code-map, trends, smoke, report, and context packs group import gaps into likely expected gaps versus gaps needing review, with categories for asset/data imports, dynamic imports, suffix-resolution gaps, aliases, local missing modules, and test fixtures.
