...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-health forgeflow-learnings forgeflow-metrics forgeflow-noisy-command forgeflow-pilot forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js privacy-boundary.js record-agent-feedback.js record-first-run-result.js record-implementation-notes.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-evaluation-report.js render-first-run-guide.js render-forgeflow-report.js render-guided-repair.js render-profile-review.js render-release-notes.js render-release-readiness.js render-release-verify.js render-pilot-script.js render-ship-presentation.js
  rollup-agent-feedback.js rollup-pattern-learnings.js rollup-pilot-evidence.js rollup-project-learnings.js runtime-helper-contract.js seed-budget-config.js show-code-map.js show-project-learnings.js show-project-trends.js ship-ci-status.sh ship-open-pr.sh ship-prepare.sh summarize-calibration.js render-support-bundle.js
