...
| Support bundle | `scripts/forgeflow/render-support-bundle.js` | Writes a local support/debug bundle with version, health, smoke, plan-only release readiness, docs drift, project trends, and consolidated next actions. |
