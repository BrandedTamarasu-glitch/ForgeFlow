...
- **Smoke check:** `smoke-check.js` runs health, trends refresh, report refresh, code map, and, when source-tree test scripts are available, doc-links and release-version guards in one local stabilization check.
