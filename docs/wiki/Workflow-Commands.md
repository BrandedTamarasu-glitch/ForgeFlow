...
| `/forgeflow-support` | Write a local support bundle with version, health, smoke, plan-only release readiness, docs drift, project trends, and consolidated next actions. Treat it as local support data because it may include local paths. |
