...
const checks = [
  ...
  ['code map gap summary separates expected from review', codeMapGapSummary({ limits: { production_total: 2, test_fixture_total: 1 }, triage: { expected_total: 2, accepted_total: 1, needs_review_total: 0 } }).explanation.includes('1 local acceptance') && codeMapGapSummary({ limits: { production_total: 3 }, triage: { expected_total: 1, needs_review_total: 2 } }).explanation.includes('need review')],
