...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-architecture forgeflow-code-map forgeflow-command-args forgeflow-command-capability forgeflow-command-interface-evidence forgeflow-command-wrapper-batch forgeflow-compact-output forgeflow-context-advisor forgeflow-context-contract forgeflow-context-retention forgeflow-context-wave-build forgeflow-context-wave-plan forgeflow-capture-output forgeflow-dogfood-refresh-plan forgeflow-dogfood-report forgeflow-drift forgeflow-efficiency-gaps forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-first-run-simulator forgeflow-first-task-adoption-loop forgeflow-first-task-report forgeflow-first-useful-win forgeflow-health forgeflow-health-timeline forgeflow-insight-injection forgeflow-invocation-hints forgeflow-lean-adapter-contract forgeflow-lean-adapter-drift forgeflow-lean-adapter-smoke forgeflow-lean-audit forgeflow-lean-behavior forgeflow-lean-benchmark forgeflow-lean-benchmark-results forgeflow-lean-benchmark-runner forgeflow-lean-correctness forgeflow-lean-debt forgeflow-lean-decision forgeflow-lean-demo-report forgeflow-lean-eval forgeflow-lean-hook-contract forgeflow-lean-host-adapters forgeflow-lean-host-cli-probes forgeflow-lean-host-command-parity forgeflow-lean-host-packages forgeflow-lean-lab forgeflow-lean-mode forgeflow-lean-openclaw-skill forgeflow-lean-pi-smoke forgeflow-lean-portability forgeflow-lean-prime forgeflow-lean-report forgeflow-lean-robustness forgeflow-lean-review forgeflow-lean-rule-canary forgeflow-lean-session forgeflow-lean-skills forgeflow-lean-status forgeflow-lean-windows-smoke forgeflow-learning-action forgeflow-learning-capture-nudge forgeflow-learning-policy forgeflow-learning-status forgeflow-learnings forgeflow-memory-correct forgeflow-metrics forgeflow-next-action-audit forgeflow-next-work-outcome forgeflow-next-work-ranking forgeflow-noisy-command forgeflow-output-contract forgeflow-outcome-capture-plan forgeflow-ownership forgeflow-pattern-review forgeflow-pilot forgeflow-post-release-install-verify forgeflow-profile forgeflow-profile-bootstrap forgeflow-profile-review forgeflow-project-brief forgeflow-project-model forgeflow-release-check forgeflow-release-consumption forgeflow-release-consumption-loop forgeflow-release-follow-through forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-skills forgeflow-review-auto-classify forgeflow-review-auto-evidence forgeflow-review-autofix-apply forgeflow-review-autofix-sandbox forgeflow-review-autofix-status forgeflow-review-evidence-schema forgeflow-review-wave-prep forgeflow-runtime-drift forgeflow-smoke forgeflow-stale-artifact-plan forgeflow-support forgeflow-sync forgeflow-telemetry-quality forgeflow-trends forgeflow-update-verify forgeflow-validation-failure-capture forgeflow-validation-plan forgeflow-version forgeflow-workflow-ending-capture forgeflow-workflow-readiness forgeflow-wrapper-drift-plan
  forgeflow-research-divergence-advice forgeflow-research-divergence-eval forgeflow-command-interface-learning forgeflow-command-interface-observe forgeflow-command-interface-learning-outcome handoff implement plan quick research review review-auto ship sync-upstream ui-iterate update-forgeflow
)
EXPECTED_SUBDIR_COMMANDS=(agent-chat/on agent-chat/off)
EXPECTED_PROJECT_RULES=(commit-hygiene dev-environment)
EXPECTED_HOOKS=(forgeflow-gate forgeflow-context-monitor forgeflow-lean-activate forgeflow-statusline forgeflow-telemetry)
EXPECTED_TEMPLATES=(ship-presentation.html)
EXPECTED_RUNTIME_HELPERS=(
  advise-context.js advise-noisy-command.js agent-chat-off.sh agent-chat-on.sh apply-review-autofix-proposal.js build-code-topology.js build-context-pack.js build-context-wave.js build-failure-digest.js build-memory-context.js build-project-intelligence.js build-project-operating-model.js build-review-autofix-proposal.js
  ...
  compact-command-output.js command-interface-learning.js correct-project-learning.js record-command-interface-observation.js record-command-interface-learning-outcome.js
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js lean-config.js lean-rule-builder.js memory-retrieval.js next-action-contract.js output-contract.js privacy-boundary.js record-agent-feedback.js record-first-run-result.js record-implementation-notes.js record-next-work-outcome.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-architecture-docs.js render-command-capability-matrix.js render-command-index.js render-command-wrapper-batch.js render-context-retention.js render-context-wave-plan.js render-dogfood-refresh-plan.js render-dogfood-report.js render-efficiency-gap-plan.js render-evaluation-report.js render-first-run-guide.js render-first-run-simulator.js render-first-task-adoption-loop.js render-first-task-report.js render-first-useful-win.js render-forgeflow-report.js render-forgeflow-skills.js render-guided-repair.js render-insight-injection.js render-invocation-hints.js render-lean-adapter-contract.js render-lean-adapter-drift.js render-lean-adapter-smoke.js render-lean-audit.js render-lean-behavior-eval.js render-lean-benchmark.js render-lean-benchmark-results.js render-lean-benchmark-runner.js render-lean-correctness.js render-lean-debt.js render-lean-decision.js render-lean-demo-report.js render-lean-eval-pack.js render-lean-hook-contract.js render-lean-host-adapters.js render-lean-host-cli-probes.js render-lean-host-command-parity.js render-lean-host-packages.js render-lean-lab.js render-lean-mode.js render-lean-openclaw-skill.js render-lean-portability-pack.js render-lean-prime.js render-lean-report.js render-lean-review.js render-lean-robustness-eval.js render-lean-rule-canary.js render-lean-session.js render-lean-skills.js render-lean-status.js render-learning-action-router.js render-learning-capture-nudge.js render-next-work-ranking.js render-ownership-map.js render-outcome-capture-plan.js render-pattern-review.js render-post-release-install-verify.js render-profile-bootstrap.js render-profile-review.js render-project-decision-brief.js render-research-divergence.js render-review-auto-evidence.js render-review-wave-prep.js render-release-consumption-loop.js render-release-consumption-rollup.js render-release-follow-through.js render-release-notes.js render-release-readiness.js render-release-verify.js render-pilot-script.js render-ship-presentation.js render-telemetry-quality.js render-workflow-ending-capture.js render-wrapper-drift-plan.js
  rollup-agent-feedback.js rollup-first-run-results.js rollup-pattern-learnings.js rollup-pilot-evidence.js rollup-project-learnings.js run-lean-pi-smoke.js run-review-autofix-sandbox.js runtime-drift-snapshot.js runtime-helper-contract.js runtime-inventory.js seed-budget-config.js show-code-map.js show-project-health-timeline.js show-learning-status.js show-project-learnings.js show-project-trends.js show-review-autofix-status.js ship-ci-status.sh ship-open-pr.sh ship-prepare.sh summarize-calibration.js render-support-bundle.js
  render-research-divergence-advice.js render-research-divergence-eval-results.js render-research-divergence-eval.js render-research-divergence-study-judge.js render-research-divergence-study.js smoke-check.js summarize-context-telemetry.js update-forgeflow.js render-stale-artifact-plan.js render-update-verify.js render-validation-failure-capture.js render-validation-plan.js render-workflow-readiness.js run-research-divergence-study-codex.js run-research-divergence-study.js show-user-profile.js user-profile.js project-learning-conflicts.js
)
```
