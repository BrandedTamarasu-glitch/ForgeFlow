...
function helperGroupForSource(source) {
  ...
  if (/^(build-|check-context|context-|compact-|capture-|failure-|advise-|seed-budget|render-architecture|render-context|render-dogfood|render-invocation|render-ownership|render-stale|render-validation|show-code|show-project-trends)/.test(file)) {
