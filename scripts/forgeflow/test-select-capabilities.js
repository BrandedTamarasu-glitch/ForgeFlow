...
for (const capability of CAPABILITIES) {
  ...
  assert.equal(capability.availability, ['change-propagation', 'visual-acceptance', 'persistence-recovery', 'review-calibration'].includes(capability.id) ? 'evaluation' : 'planned');
}
