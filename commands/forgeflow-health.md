...
EXPECTED_RUNTIME_HELPERS=(
  ...
  index-memory.js install-manifest.js install-template.js record-pilot-evidence.js record-review-outcome.js render-evaluation-report.js render-ship-presentation.js
  rollup-pilot-evidence.js rollup-project-learnings.js seed-budget-config.js ship-ci-status.sh ship-open-pr.sh ship-prepare.sh summarize-calibration.js
