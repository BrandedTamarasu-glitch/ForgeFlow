...
| `/forgeflow-health` | Audit installation, project-local state, latest project-learning quality, and latest-insights readiness; can safely repair `.forgeflow/` scaffolding and budget config. |
...
| `/forgeflow-report` | Produce a script-backed status report including local metrics, false-positive thresholds, pattern freshness, context trends, project trends, and latest-insights readiness. |
