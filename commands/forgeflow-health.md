...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-command-args forgeflow-compact-output forgeflow-context-contract forgeflow-context-retention forgeflow-context-wave-plan forgeflow-capture-output forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-first-task-adoption-loop forgeflow-first-task-report forgeflow-first-useful-win forgeflow-health forgeflow-health-timeline forgeflow-insight-injection forgeflow-learning-policy forgeflow-learning-status forgeflow-learnings forgeflow-metrics forgeflow-next-action-audit forgeflow-next-work-outcome forgeflow-noisy-command forgeflow-output-contract forgeflow-pattern-review forgeflow-pilot forgeflow-post-release-install-verify forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-follow-through forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-review-auto-classify forgeflow-review-auto-evidence forgeflow-review-evidence-schema forgeflow-runtime-drift forgeflow-smoke forgeflow-stale-artifact-plan forgeflow-support forgeflow-sync forgeflow-trends forgeflow-update-verify forgeflow-validation-plan forgeflow-version
...
EXPECTED_RUNTIME_HELPERS=(
  ...
  index-memory.js install-manifest.js install-template.js latest-insights-state.js next-action-contract.js output-contract.js privacy-boundary.js record-agent-feedback.js record-first-run-result.js record-implementation-notes.js record-next-work-outcome.js record-pilot-evidence.js record-project-learning.js record-review-outcome.js record-user-profile.js render-adoption-pack.js render-context-retention.js render-context-wave-plan.js render-evaluation-report.js render-first-run-guide.js render-first-task-adoption-loop.js render-first-task-report.js render-first-useful-win.js render-forgeflow-report.js render-guided-repair.js render-insight-injection.js render-pattern-review.js render-post-release-install-verify.js render-profile-review.js render-review-auto-evidence.js render-release-follow-through.js render-release-notes.js render-release-readiness.js render-release-verify.js render-pilot-script.js render-ship-presentation.js
  rollup-agent-feedback.js rollup-first-run-results.js rollup-pattern-learnings.js rollup-pilot-evidence.js rollup-project-learnings.js runtime-drift-snapshot.js runtime-helper-contract.js seed-budget-config.js show-code-map.js show-project-health-timeline.js show-learning-status.js show-project-learnings.js show-project-trends.js ship-ci-status.sh ship-open-pr.sh ship-prepare.sh summarize-calibration.js render-support-bundle.js
  smoke-check.js summarize-context-telemetry.js update-forgeflow.js render-stale-artifact-plan.js render-update-verify.js render-validation-plan.js show-user-profile.js user-profile.js
)
```
