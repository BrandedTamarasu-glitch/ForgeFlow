---
name: architect-intelligence
description: Canonical Architect Intelligence reference. Not an agent — a shared reference file. Update here, then copy relevant sections into architect-{consult,implement,review}.md.
---
...
Three named protocols. Architect applies the subset relevant to the active mode.
