...
EXPECTED_COMMANDS=(
  ...
  forgeflow-adoption forgeflow-code-map forgeflow-compact-output forgeflow-drift forgeflow-failure-digest forgeflow-first-run forgeflow-first-run-result forgeflow-first-run-rollup forgeflow-health forgeflow-learnings forgeflow-metrics forgeflow-next-work-outcome forgeflow-noisy-command forgeflow-pilot forgeflow-profile forgeflow-profile-review forgeflow-release-check forgeflow-release-readiness forgeflow-release-verify forgeflow-repair forgeflow-report forgeflow-smoke forgeflow-support forgeflow-sync forgeflow-trends forgeflow-version
